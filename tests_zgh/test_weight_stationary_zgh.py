...
def pytorch_ref(expert_ups, expert_downs, expert_gates, input_tensor, indices, weights, E, N, D) -> OffChipStore:
...
def step_impl(expert_ups, expert_downs, expert_gates, input_tensor, indices, weights, E, N, D, F, tile_F):
...
def test_expert():
    ...
    gold = pytorch_ref(expert_ups, expert_downs, expert_gates, input_tensor, indices, selected_weights, E, N, D)
    output = step_impl(expert_ups, expert_downs, expert_gates, input_tensor, indices, selected_weights, E, N, D, F, tile_F)
