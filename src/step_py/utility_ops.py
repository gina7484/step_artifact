...
class CacheWriteAddrGen(StepOps):
    """
    ...
    def __init__(
        ...
        self._stream = Stream(stream_dtype=Uint64(), shape=get_stream(idx).shape)
...
class MetadataGen(StepOps):
    ...
    def __init__(self, tensor: torch.Tensor):
        ...
        self._stream = Stream(stream_dtype=Uint64(), shape=(1,) + tuple(tensor.shape))
